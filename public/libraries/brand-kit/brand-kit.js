        ...
        <section class="company-settings-card">
          ...
          <div class="company-settings-card-body">
            <div class="brand-color-main">
              ...
              <div class="brand-color-control"><input type="color" class="cs-color" id="${id('Secondary')}"><div class="brand-color-copy"><label for="${id('SecondaryHex')}">${(globalThis.PlatformLanguage?.htmlText("brand-kit","m_390a15f2a6d920","Secondary · UI") ?? "Secondary · UI")}</label><span class="cs-chip" id="${id('SecondaryChip')}"><span class="hash">#</span><input id="${id('SecondaryHex')}" maxlength="6" autocomplete="off" spellcheck="false"></span></div></div>
            </div>
