...
(function(){
  ...
  function viewReference(key){
    ...
    referenceViewer=window.FirstMateMarkup.openPhotoViewer({photos,index:photos.findIndex(p=>p.media_id===entry.media_id),project:{title:'Exterior reference photos'},boundsTarget:photoWorkspace.querySelector('[data-reference-gallery]'),embedded:true,projectLinkEnabled:false,
  ...
  .r-overlay.exteriors-active #rStepReport,.r-overlay.exteriors-choose #rStepReport,.r-overlay.exteriors-active #rExpeditePanel,.r-overlay.exteriors-active #rMobilePager{display:none!important}
  @media(max-width:720px){.r-overlay.exteriors-active .r-win{height:calc(var(--fm-visual-vh,100dvh) - 24px);max-height:none}.r-overlay.exteriors-active .r-left{display:flex!important;position:relative!important;inset:auto!important;transform:none!important;pointer-events:auto!important;width:100%!important;max-width:none;max-height:none;flex:1 1 auto;min-height:0;overflow:hidden;padding:52px 12px 12px!important;box-shadow:none}.r-overlay.exteriors-active .r-right{display:none}.r-overlay.exteriors-active .r-scroll{overflow:auto}.r-overlay.exteriors-active #rMobileClose{display:flex;position:absolute;top:8px;right:12px;width:36px;height:36px;border:1px solid #e4e7ec;border-radius:10px;background:#fff;z-index:100;align-items:center;justify-content:center}.r-overlay.exteriors-active .r-top{display:block!important}.r-overlay.exteriors-active .r-scroll{padding:0!important}.ext-choice{padding:12px}}
  ...
  .r-overlay.exteriors-active .r-left-bottom{display:flex}.r-overlay.exteriors-details #rStepCustomer,.r-overlay.exteriors-details #rStepAddress{display:none!important}
  ...
  @media(max-width:720px){.ext-map-edit{display:block;width:100%;margin:8px 0}.ext-order #rPinInfo{display:flex!important}.ext-order #rConfirm{display:flex!important}.r-overlay.exteriors-active #rStepType{display:block!important}.r-overlay.exteriors-active #rTypeGroup{display:grid!important}}
  @media(max-width:720px){.ext-choice strong,.ext-choices.compact strong{font-size:10px}}
...
`;
  ...
  function render(){const scroller=root?.closest('.r-scroll');const savedScroll=scroller?.scrollTop;const focused=document.activeElement;const caret=focused&&/^(INPUT|TEXTAREA)$/.test(focused.tagName)?[focused.selectionStart,focused.selectionEnd]:null;restoreShared();if(!ctx)return;const step=document.getElementById('rStepType');if(!step)return;
    ...
    const visible=!ctx.ordered && ctx.type && allowed(ctx.type) && ctx.orderWorkflow;
    root.hidden=!visible;const overlay=document.getElementById('rOverlay');overlay?.classList.toggle('exteriors-active',!!visible&&active());overlay?.classList.toggle('exteriors-choose',!!visible&&!scope);
    ...
    if(active()&&page===0){mountShared('rPinInfo','[data-pin-mount]');mountShared('rConfirm','[data-confirm-mount]');mountShared('rTechNotes','[data-notes-mount]',true);mountShared('rCcList','[data-cc-mount]',true);}
  ...
  P.ExteriorOrder={active,reset,render,renderPhotos:renderPhotoWorkspace,previewTabChanged(tab){if(tab!=='photos')closeReferenceViewer();},
