...
(function(){
  const P=window.Portal, esc=P.util.escapeHtml, views=['front','front-left','left','back-left','back','back-right','right','front-right'];
  ...
  const files=new Map();
  P.util.injectCSS('exterior-guided-capture',`
    .ext-capture{--capture-green:#27734b;font-size:14px}.ext-capture-heading{display:flex;justify-content:space-between;align-items:center;gap:8px;margin-bottom:12px}.ext-capture-heading>span{font-size:10px;font-weight:800;letter-spacing:1.4px;color:#667085}.ext-capture h3{font-size:23px;letter-spacing:-.6px;margin-bottom:6px}.ext-capture p{margin:6px 0 12px}.ext-camera{height:clamp(230px,40dvh,420px);position:relative;background:linear-gradient(145deg,#182b29,#0c1419);border-radius:22px;overflow:hidden;isolation:isolate}.ext-camera video{width:100%;height:100%;object-fit:cover;display:block;visibility:hidden}.ext-camera.live video{visibility:visible}.ext-camera-idle{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:12px;color:#aebfbc}.ext-camera-idle>i{font-size:32px}.ext-camera.live .ext-camera-idle{display:none}.ext-camera-status{position:absolute;bottom:12px;left:12px;right:12px;background:#101828b8;color:#fff;font-size:12px;line-height:1.4;border-radius:12px;padding:8px 12px;pointer-events:none}.ext-camera-status:empty{display:none}.ext-angle-guide{position:absolute;top:10px;right:10px;width:128px;height:142px;background:#fffffff0;border:1px solid #fff;border-radius:18px;display:flex;align-items:center;flex-direction:column;color:#234439;box-shadow:0 4px 20px #0002}.ext-angle-guide strong{font-size:11px;margin-top:-8px}.ext-model-scene{width:124px;height:118px;perspective:500px;display:grid;place-items:center;overflow:hidden}.ext-model{position:relative;width:80px;height:60px;transform-style:preserve-3d;transition:transform .7s cubic-bezier(.22,.7,.24,1);transform:rotateX(-18deg) rotateY(-25deg)}.ext-model>*{position:absolute;backface-visibility:hidden}.ext-ground{width:124px;height:124px;left:-22px;top:-32px;background:#cfe1d2;border-radius:14px;transform:rotateX(90deg) translateZ(-62px)}.ext-wall{width:80px;height:56px;top:12px;background:#faf6e9;border:1px solid #d3d6c9;display:flex;align-items:center;justify-content:space-around}.ext-wall.front{transform:translateZ(40px)}.ext-wall.back{transform:rotateY(180deg) translateZ(40px);background:#e3e6d9}.ext-wall.left{transform:rotateY(-90deg) translateZ(40px);background:#e9eddf}.ext-wall.right{transform:rotateY(90deg) translateZ(40px);background:#eceddf}.ext-wall i{width:16px;height:19px;background:linear-gradient(90deg,transparent 45%,#f3f7ee 45%,#f3f7ee 55%,transparent 55%),linear-gradient(transparent 45%,#f3f7ee 45%,#f3f7ee 55%,transparent 55%),#87afba;border:2px solid #fff}.ext-wall b{height:32px;width:16px;background:#497c69;align-self:flex-end;border:2px solid #fff;border-bottom:0}.ext-gable{width:80px;height:31px;top:-18px;clip-path:polygon(50% 0,100% 100%,0 100%);background:#f4f0e0}.ext-gable.front{transform:translateZ(40px)}.ext-gable.back{transform:rotateY(180deg) translateZ(40px)}.ext-roof{width:52px;height:88px;background:repeating-linear-gradient(0deg,#465d59 0 9px,#3a504c 9px 10px);top:-47px;left:14px;border:1px solid #304641}.ext-roof.left{transform:translateX(-21px) rotateX(90deg) rotateY(-36deg)}.ext-roof.right{transform:translateX(21px) rotateX(90deg) rotateY(36deg)}.ext-path{width:90px;height:20px;left:-5px;top:81px;transform:rotateX(90deg) translateZ(25px);background:#afbcbb;color:#fff;text-align:center;font-size:9px;letter-spacing:2px;line-height:20px}.ext-shutter-row{display:flex;align-items:center;justify-content:space-evenly;gap:12px;margin:16px 0 10px}.ext-shutter{width:64px;height:64px;flex-shrink:0;border:5px solid white;outline:2px solid #27734b;border-radius:50%;background:#27734b;color:white;font-size:23px;cursor:pointer}.ext-shutter-control{display:flex;flex-direction:column;align-items:center;gap:8px}.ext-shutter-control>span{font-size:12px;font-weight:600;color:#344054}.ext-shutter:active{transform:scale(.94)}.ext-angle-photos{display:flex;gap:8px;overflow:auto;margin-bottom:12px}.ext-angle-photos>div{position:relative;flex:0 0 118px;background:#f2f5f4;border-radius:12px;overflow:hidden}.ext-angle-photos img{width:118px;height:88px;object-fit:cover}.ext-angle-photos span{display:block;font-size:10px;padding:5px}.ext-angle-photos button{border:0;background:white;color:#245e41;padding:6px;font:inherit;font-size:11px;cursor:pointer}.ext-angle-photos [data-guide-remove]{position:absolute;right:4px;top:4px;border-radius:50%;width:28px;height:28px;font-size:18px;padding:0}.ext-guide-footer{position:sticky;bottom:0;background:#fff;padding:12px 0 4px;z-index:3}.ext-guide-progress{height:5px;border-radius:8px;background:#e5ede8;overflow:hidden}.ext-guide-progress span{display:block;height:100%;background:#27734b;transition:width .3s}.ext-guide-progress-label{font-size:11px;color:#667085;margin:7px 0 10px;text-align:center}.ext-guide-buttons{display:flex;gap:10px}.ext-guide-buttons button{min-height:44px}.ext-guide-buttons [data-guide-forward]{flex:1;background:#27734b;color:white;border-color:#27734b}.ext-photo-summary-head{display:flex;justify-content:space-between;align-items:center;gap:12px}.ext-photo-summary-head h3{font-size:22px}.ext-photo-summary-head p{margin:6px 0}.ext-photo-extras{display:flex;flex-wrap:wrap;gap:8px;margin:16px 0}.ext-photo-extras h3{flex-basis:100%}.ext-summary-extra{display:flex;align-items:center;gap:8px;padding:8px;border:1px solid #e4e7ec;border-radius:12px;margin:8px 0}.ext-summary-extra img{width:48px;height:48px;object-fit:cover;border-radius:8px}.ext-summary-extra span{flex:1;min-width:0;overflow-wrap:anywhere}.ext-summary-extra button{flex-shrink:0}.ext-summary-guide .ext-house{overflow:hidden}.ext-summary-guide .ext-model-scene{transform:scale(.8);margin:-10px}.ext-summary-guide .ext-view{min-height:104px}.ext-summary-guide .ext-view>button[data-view]{min-height:104px}
    @media(max-width:720px){.r-overlay.mobile-order-photos.ext-guiding .r-mobile-pager{display:none!important}.r-overlay.mobile-order-photos.ext-guiding .r-scroll{padding-bottom:8px!important}.r-overlay.mobile-order-photos .ext-order{margin:0}.r-overlay.mobile-order-photos .ext-pages{margin-top:0}.r-overlay.mobile-order-details.exteriors-active .r-group{margin-bottom:18px}.r-overlay.mobile-order-details .r-contact-card .r-inp{font-size:13px}.r-overlay.mobile-order-details.exteriors-active .ext-delivery-heading{margin-top:20px}.r-overlay.mobile-order-details.exteriors-active .ext-summary{font-size:14px}.r-overlay.mobile-order-final .ext-summary div{flex-wrap:wrap}.r-overlay.mobile-order-final .ext-summary strong{overflow-wrap:anywhere}.r-overlay.mobile-order-photos .ext-tool{min-height:44px}}
    .ext-order .ext-capture h3,.ext-order .ext-photo-summary-head h3{font-size:23px;line-height:1.2}.ext-angle-guide .ext-model{scale:.8}.ext-angle-guide strong{margin-top:0}.ext-angle-guide .ext-model-scene{height:116px}.ext-order .ext-guide-footer{padding-bottom:max(8px,env(safe-area-inset-bottom,0px))}html[data-native-app="android"] .ext-order .ext-guide-footer{padding-bottom:8px}
    @media(max-width:720px){.r-overlay.mobile-order-photos.ext-guiding .r-win{padding-bottom:0!important}}
    .ext-capture-heading{display:grid;grid-template-columns:minmax(0,1fr) 104px;gap:12px;margin:0;min-height:98px}.ext-capture-heading>div:first-child{min-width:0}.ext-capture-heading [data-guide-step]{display:block;margin-top:8px;font-size:12px;color:#667085}.ext-capture-heading .ext-angle-guide{position:static;width:104px;height:98px;box-shadow:none;background:#f4f7f4;border:0;border-radius:16px}.ext-capture-heading .ext-model-scene{width:104px;height:98px}.ext-capture-heading .ext-model{scale:.7}.ext-camera{height:auto;min-height:0}.ext-camera video{position:absolute;inset:0}.ext-shutter-row{position:relative;justify-content:center;margin:0;padding:10px 0 6px}.ext-shutter{width:58px;height:58px}.ext-shutter-control{gap:5px}.ext-shutter-row [data-guide-retry-camera]{position:absolute;right:0;max-width:90px;font-size:11px}.ext-guide-footer{position:static;padding:6px 0 4px!important}.ext-guide-footer .ext-shutter{box-sizing:border-box}.ext-guide-footer .ext-shutter-control{padding:2px}.ext-guide-buttons{display:grid;grid-template-columns:minmax(0,.7fr) minmax(0,1.2fr) minmax(0,1.2fr);gap:8px}.ext-guide-buttons .ext-tool{padding:8px 4px;min-height:44px;font-size:12px;white-space:nowrap}.ext-angle-photos{position:absolute;bottom:10px;left:10px;right:10px;max-height:108px;margin:0}.ext-angle-photos:empty{display:none}.ext-angle-photos>div{flex-basis:96px}.ext-angle-photos img{width:96px;height:52px}.ext-angle-photos span{padding:3px;font-size:9px}.ext-angle-photos button{padding:4px}.ext-extra-drop{width:100%;min-height:170px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;border:2px dashed #a4b8ab;border-radius:18px;background:#f7faf8;color:#355b45;font:inherit;cursor:pointer}.ext-extra-drop>i{font-size:28px}.ext-extra-drop strong{font-size:18px}.ext-extra-drop span{font-size:14px;color:#667085}.ext-extra-drop:hover,.ext-extra-drop:focus-visible{background:#edf5ef;border-color:#27734b}
    @media(max-width:720px){.r-overlay.mobile-order-photos.ext-guiding .r-scroll{display:flex;flex-direction:column;overflow:hidden!important;scrollbar-gutter:auto;padding-bottom:0!important}.r-overlay.mobile-order-photos.ext-guiding #rExteriorOrder{display:flex;flex-direction:column;flex:1;min-height:0;margin:0}.r-overlay.mobile-order-photos.ext-guiding .ext-pages,.r-overlay.mobile-order-photos.ext-guiding [data-guide-mount]{display:flex;flex-direction:column;flex:1;min-height:0}.r-overlay.mobile-order-photos.ext-guiding .ext-capture{display:grid;grid-template-rows:auto minmax(0,1fr) auto auto;gap:8px;flex:1;min-height:0}.r-overlay.mobile-order-photos.ext-guiding .r-form{gap:0;margin:0}.r-overlay.mobile-order-photos.ext-guiding .ext-progress{display:none}.r-overlay.mobile-order-photos.ext-guiding .ext-error{flex-shrink:0}.r-overlay.mobile-order-photos.ext-guiding .r-left{padding-bottom:max(8px,env(safe-area-inset-bottom,0px))}html[data-native-app="android"] .r-overlay.mobile-order-photos.ext-guiding .r-left{padding-bottom:8px}}
    .ext-photo-dock{position:absolute;bottom:12px;left:12px;right:12px;display:flex;gap:6px;align-items:center;min-width:0;z-index:2}.ext-upload-tile{flex:0 0 76px;width:76px;height:76px;border:1px dashed #ffffffa8;border-radius:12px;background:#f8fff5ed;color:#276346;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;font:inherit;cursor:pointer}.ext-upload-tile i{font-size:22px}.ext-upload-tile span{font-size:11px;font-weight:600}.ext-photo-dock .ext-angle-photos{position:static;display:flex;flex:1;min-width:0;gap:8px;overflow-x:auto;overflow-y:hidden;max-height:none;margin:0;padding:4px 4px 4px 8px;mask-image:linear-gradient(to right,transparent,#000 8px);scrollbar-width:none;overscroll-behavior-x:contain}.ext-photo-dock .ext-angle-photos::-webkit-scrollbar{display:none}:is(.ext-photo-dock,.ext-summary-tiles) .ext-photo-tile{position:relative;flex:0 0 76px;width:76px;height:76px;border-radius:12px;overflow:visible;background:#1d2925;border:2px solid transparent;box-sizing:border-box}:is(.ext-photo-dock,.ext-summary-tiles) .ext-photo-tile.primary{border-color:#69d79b;box-shadow:0 0 0 1px #123e28}:is(.ext-photo-dock,.ext-summary-tiles) .ext-photo-tile .ext-thumb-select{position:relative;width:100%;height:100%;border:0;padding:0;display:block;overflow:hidden;border-radius:9px;cursor:pointer;background:none}:is(.ext-photo-dock,.ext-summary-tiles) .ext-photo-tile img{display:block;width:100%;height:100%;object-fit:cover}:is(.ext-photo-dock,.ext-summary-tiles) .ext-photo-tile .ext-thumb-primary{position:absolute;bottom:0;left:0;right:0;display:block;padding:4px 0;background:#102b20e8;color:#8af0b5;font-size:10px;font-weight:700;text-align:center;line-height:1.2}:is(.ext-photo-dock,.ext-summary-tiles) .ext-photo-tile .ext-thumb-remove{position:absolute;right:3px;top:3px;width:24px;height:24px;min-height:24px;max-height:24px;padding:0;line-height:24px;border:0;border-radius:50%;background:#fff;color:#263c31;font:inherit;font-size:18px;z-index:4;cursor:pointer;display:grid;place-items:center}:is(.ext-photo-dock,.ext-summary-tiles) .ext-photo-tile .ext-thumb-busy{position:absolute;inset:0;display:grid;place-items:center;background:#06120a66;padding:0}.ext-thumb-busy i{display:block;width:20px;height:20px;border:2px solid #ffffff66;border-top-color:white;border-radius:50%;animation:extPhotoUploadSpin .75s linear infinite}:is(.ext-photo-dock,.ext-summary-tiles) .ext-photo-tile .ext-thumb-retry{position:absolute;left:4px;right:4px;top:27px;z-index:3;border-radius:6px;background:#fff;color:#8e2721;font-size:10px;padding:3px}:is(.ext-photo-dock,.ext-summary-tiles) .ext-photo-tile .ext-thumb-error{position:absolute;left:0;right:0;top:0;font-size:9px;color:#fff;background:#992b26;padding:3px;pointer-events:none}.ext-thumb-error:empty{display:none!important}.ext-capture-flight{position:fixed;pointer-events:none;z-index:100000;object-fit:cover;transform-origin:top left}.ext-camera [data-guide-retry-camera]{position:absolute;top:12px;left:12px;z-index:3}.ext-camera-status:not(:empty){bottom:108px}.ext-guide-footer .ext-guide-buttons{grid-template-columns:minmax(0,1fr) 82px minmax(0,1fr);align-items:center;gap:12px;padding:7px 0 0}.ext-guide-footer .ext-shutter-control{justify-self:center}.ext-guide-footer [data-guide-back],.ext-guide-footer [data-guide-forward]{align-self:center}.ext-summary-guide .ext-view>button.ext-remove{width:32px;height:32px;min-height:32px;max-height:32px;aspect-ratio:1;padding:0;justify-content:center;align-items:center;border-radius:50%}
    .ext-summary-group{margin:20px 0}.ext-summary-group h4{margin:0 0 10px;font-size:15px}.ext-summary-group h4 button{float:right;border:0;background:none;color:#27734b;font:inherit;font-size:13px;cursor:pointer}.ext-summary-tiles{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}.ext-summary-tiles .ext-photo-tile{width:100%;height:auto;aspect-ratio:1;min-width:0}.ext-summary-tiles .ext-thumb-remove{min-width:24px;max-width:24px}.ext-summary-empty{color:#667085;font-size:13px;margin:0}.ext-photo-toast{position:fixed;right:16px;bottom:calc(90px + env(safe-area-inset-bottom,0px));max-width:calc(100vw - 32px);box-sizing:border-box;background:#243c30;color:white;padding:14px 18px;border-radius:14px;box-shadow:0 6px 24px #0003;z-index:100001;font-size:14px;pointer-events:none}.ext-guide-footer .ext-guide-buttons{padding-top:3px}
    .ext-review-section{margin:0 0 20px}.ext-review-section>h3{margin:0 0 12px}.ext-review-section .ext-photo-grid{margin-bottom:12px}.ext-review-view{position:relative;overflow:hidden}.ext-review-view>img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}.ext-review-section .ext-review-view>.ext-caption{position:absolute;bottom:0;left:0;right:0;padding:6px;background:#ffffffe8;font-size:11px;text-align:center}
    @media(max-width:720px){.r-overlay.mobile-order-details .r-mobile-customer-heading{display:block;margin:0 0 8px;font-size:13px;color:#667085}.r-overlay.mobile-order-details .r-contact-card .r-mobile-customer-label{display:none}.r-overlay.mobile-order-details #rStepCustomer .r-group{margin:0;gap:6px}.r-overlay.mobile-order-details #rStepCustomer .r-step-body{padding-bottom:0;gap:8px}.r-overlay.mobile-order-details #rStepCustomer{margin-bottom:12px}.r-overlay.mobile-order-details .r-contact-card{padding:8px;gap:8px;align-content:start}.r-overlay.mobile-order-details .r-contact-card .r-inp{min-height:40px;box-sizing:border-box}.r-overlay.mobile-order-details #rTechNotes{margin-top:0}}
    .r-mobile-customer-heading{display:none}
    @keyframes extPhotoUploadSpin{to{transform:rotate(360deg)}}
    @media(max-width:720px){.r-overlay.mobile-order-photos.ext-guiding .ext-capture{grid-template-rows:auto minmax(0,1fr) auto}}
    @media(prefers-reduced-motion:reduce){.ext-thumb-busy i{animation-duration:1.5s}}
  ...
  function houseModel(){return `<div class="ext-model-scene" role="img" aria-label="House angle guide"><div class="ext-model"><div class="ext-ground"></div><div class="ext-wall front"><i></i><b></b><i></i></div><div class="ext-wall back"><i></i><i></i></div><div class="ext-wall left"><i></i><i></i></div><div class="ext-wall right"><i></i><i></i></div><div class="ext-gable front"></div><div class="ext-gable back"></div><div class="ext-roof left"></div><div class="ext-roof right"></div><div class="ext-path">STREET</div></div></div>`;}
  ...
  const photoTiles=new WeakMap();
  const reduceCaptureMotion=()=>window.matchMedia?.('(prefers-reduced-motion: reduce)').matches;
  function placeGuidedEntry(key,entry){const old=files.get(key);if(old){old.angleKey=key;files.set(key.split(':')[0]+':additional-'+crypto.randomUUID(),old);}files.set(key,entry);}
  function animateCapture(entry){
    const tile=photoTiles.get(entry),camera=guideNode?.querySelector('.ext-camera');if(!tile||!camera||!guideNode.isConnected)return;
    const strip=guideNode.querySelector('.ext-angle-photos');strip.scrollLeft=strip.scrollWidth;
    if(reduceCaptureMotion())return;
    const from=camera.getBoundingClientRect(),to=tile.getBoundingClientRect(),fly=document.createElement('img');fly.src=referenceThumbnail(entry);fly.className='ext-capture-flight';fly.setAttribute('aria-hidden','true');Object.assign(fly.style,{left:from.left+'px',top:from.top+'px',width:from.width+'px',height:from.height+'px'});document.body.append(fly);
    const animation=fly.animate([{transform:'translate(0,0) scale(1)',opacity:.95,borderRadius:'22px'},{transform:`translate(${to.x-from.x}px,${to.y-from.y}px) scale(${to.width/from.width},${to.height/from.height})`,opacity:.6,borderRadius:'12px'}],{duration:420,easing:'cubic-bezier(.2,.75,.25,1)'});animation.onfinish=animation.oncancel=()=>fly.remove();
    tile.animate([{opacity:.2,transform:'scale(.85)'},{opacity:1,transform:'scale(1)'}],{duration:300,delay:180,easing:'ease-out'});
    guideNode.querySelector('[data-guide-capture]').animate([{transform:'scale(.88)'},{transform:'scale(1)'}],{duration:200});
  }
  function captureGuided(){
    ...
    try{
      ...
      canvas.toBlob(blob=>{
        if(epoch!==generation||![...files.values()].includes(entry))return;
        entry.encoding=false;
        if(!blob){entry.error='Could not process photo. Please retake.';render();return;}
        entry.file=new File([blob],entry.name,{type:'image/jpeg'});entry.url=URL.createObjectURL(blob);void send(entry);
      },'image/jpeg',.9);
  ...
  function mountGuide(){
    if(!guideNode){
      guideNode=document.createElement('section');guideNode.className='ext-capture';
      guideNode.innerHTML=`<header class="ext-capture-heading"><div><h3 data-guide-title></h3><span data-guide-step></span></div><div class="ext-angle-guide">${houseModel()}</div></header><div class="ext-camera"><video autoplay muted playsinline aria-label="Live rear camera preview"></video><div class="ext-camera-idle"><i class="fas fa-camera" aria-hidden="true"></i></div><div class="ext-photo-dock"><button type="button" class="ext-upload-tile" data-guide-upload aria-label="Upload photos"><i class="fas fa-plus" aria-hidden="true"></i><span>Upload</span></button><div class="ext-angle-photos" aria-label="Photos for this angle"></div></div><span class="ext-camera-status" role="status"></span><button type="button" class="ext-tool" data-guide-retry-camera>Retry camera</button></div><footer class="ext-guide-footer"><div class="ext-guide-buttons"><button type="button" class="ext-tool" data-guide-back>Back</button><div class="ext-shutter-control"><button type="button" class="ext-shutter" data-guide-capture aria-label="Take photo"><i class="fas fa-camera" aria-hidden="true"></i></button></div><button type="button" class="ext-tool" data-guide-forward></button></div></footer>`;
  ...
  function updateGuide(){
    ...
    guideNode.querySelector('[data-guide-step]').textContent=`House ${Math.floor(guideIndex/8)+1} · View ${guideIndex%8+1} of 8`;
    guideNode.querySelector('[data-guide-title]').textContent=`${label(view)} of House`;
    ...
    const strip=guideNode.querySelector('.ext-angle-photos');
    mountPhotoTiles(strip,photos,key,view);
    if(strip.dataset.angle!==key){strip.dataset.angle=key;strip.scrollLeft=0;}
    guideNode.querySelector('[data-guide-forward]').textContent=photos.length?(guideIndex+1===total?'Review photos':'Next angle'):'Skip for now';
  }
  function mountPhotoTiles(strip,photos,key,view){
    const wanted=new Set();
    for(const [,f] of photos)if(!f.sequence)f.sequence=++captureSequence;
    photos.sort((a,b)=>(a[1].sequence||0)-(b[1].sequence||0));
    for(const [position,[k,f]] of photos.entries()){
      let tile=photoTiles.get(f);
      if(!tile){tile=document.createElement('div');tile.className='ext-photo-tile';tile.innerHTML='<button type="button" class="ext-thumb-select" data-guide-primary><img alt=""><span class="ext-thumb-busy" role="status" aria-label="Uploading photo"><i></i></span><span class="ext-thumb-primary">Primary</span></button><button type="button" class="ext-thumb-remove" data-guide-remove aria-label="Remove photo">×</button><button type="button" class="ext-thumb-retry" data-guide-retry>Retry</button><span class="ext-thumb-error" role="status"></span>';
      ...
      const select=tile.querySelector('[data-guide-primary]');select.dataset.guidePrimary=k;select.setAttribute('aria-pressed',String(k===key));select.setAttribute('aria-label',`${label(view)} photo${k===key?', Primary':key?', select as primary':', view photo'}`);
  ...
  const pending=()=>[...files.values()].some(f=>f.encoding||f.uploading||f.error);
  ...
  function reviewPhotosUI(){
    ...
    return `<section class="ext-review-section ext-summary-guide" aria-label="Photos">${Array.from({length:ctx.count},(_,i)=>`${ctx.count>1?`<h4>House ${i+1}</h4>`:''}<div class="ext-photo-grid">${layout.map(v=>{if(!v)return `<div class="ext-house">${houseModel()}</div>`;const f=files.get(i+':'+v);return `<div class="ext-view ext-review-view ${f?'has-photo':''} ${f?.media_id?'done':''}">${f?`<img src="${esc(referenceThumbnail(f))}" alt="House ${i+1}, ${esc(label(v))}">`:''}<span class="ext-caption">${label(v)}</span></div>`;}).join('')}</div>`).join('')}<div class="ext-summary"><div><span>Required angles</span><strong>${primary} / ${ctx.count*8}</strong></div><div><span>Additional photos</span><strong>${uploaded.length-primary}</strong></div><div><span>Total photos</span><strong>${uploaded.length}</strong></div></div></section>`;
  }
  function photoUI(){
...
`;
    ...
    const group=(key,title)=>`<section class="ext-summary-group"><h4>${esc(title)}${key?`<button type="button" data-view="${key}">Add photos</button>`:''}</h4><div class="ext-summary-tiles" data-summary-tiles="${key}" aria-label="${esc(title)} photos"></div></section>`;
    return `<section class="ext-summary-guide"><div class="ext-photo-extras"><button type="button" class="ext-extra-drop" data-extra-upload><i class="fas fa-cloud-arrow-up" aria-hidden="true"></i><strong>Additional photos</strong><span>Tap to upload</span></button></div>${group('','Additional photos')}${overview}${Array.from({length:ctx.count},(_,i)=>`${ctx.count>1?`<h3>House ${i+1}</h3>`:''}${views.map(v=>group(i+':'+v,label(v))).join('')}`).join('')}</section>`;
  }
  ...
  function render(){const scroller=root?.closest('.r-scroll');const savedScroll=scroller?.scrollTop;const focused=document.activeElement;const caret=focused&&/^(INPUT|TEXTAREA)$/.test(focused.tagName)?[focused.selectionStart,focused.selectionEnd]:null;restoreShared();if(!ctx)return;const step=document.getElementById('rStepType');if(!step)return;
    ...
    root.querySelectorAll('[data-view]').forEach(b=>b.onclick=()=>{const key=b.dataset.view;if(ctx.mobileOrder&&!selectedPhoto){visitGuide(Number(key.split(':')[0])*8+views.indexOf(key.split(':')[1]));return;}if(selectedPhoto)assign(selectedPhoto,key);else if(files.has(key)){selectedPhoto=key;viewReference(key);render();}else pick(key);});
    ...
    root.querySelectorAll('[data-remove]').forEach(b=>b.onclick=()=>{if(ctx.mobileOrder){removeGuided(b.dataset.remove);return;}closeReferenceViewer();const f=files.get(b.dataset.remove);if(f?.url)URL.revokeObjectURL(f.url);files.delete(b.dataset.remove);if(selectedPhoto===b.dataset.remove)selectedPhoto=null;render();});
    ...
    root.querySelectorAll('[data-view]').forEach(button=>{
      button.ondragover=e=>{if(Array.from(e.dataTransfer?.types||[]).includes('application/x-exterior-reference')){e.preventDefault();e.dataTransfer.dropEffect='move';button.closest('.ext-view,.ext-summary-group').classList.add('drop-target');}};
