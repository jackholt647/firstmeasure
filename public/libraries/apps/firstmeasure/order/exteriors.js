...
(function(){
  ...
  P.util.injectCSS('exterior-guided-capture',`
    ...
    @media(max-width:720px){.r-overlay.mobile-order-photos.ext-guiding .r-mobile-pager{display:none!important}.r-overlay.mobile-order-photos.ext-guiding .r-scroll{padding-bottom:8px!important}.r-overlay.mobile-order-photos .ext-order{margin:0}.r-overlay.mobile-order-photos .ext-pages{margin-top:0}.r-overlay.mobile-order-details.exteriors-active .r-group{margin-bottom:18px}.r-overlay.mobile-order-details.exteriors-active input,.r-overlay.mobile-order-details.exteriors-active textarea{font-size:16px}.r-overlay.mobile-order-details.exteriors-active .ext-delivery-heading{margin-top:20px}.r-overlay.mobile-order-details.exteriors-active .ext-summary{font-size:14px}.r-overlay.mobile-order-final .ext-summary div{flex-wrap:wrap}.r-overlay.mobile-order-final .ext-summary strong{overflow-wrap:anywhere}.r-overlay.mobile-order-photos .ext-tool{min-height:44px}}
