...
(function(){
  ...
  function resetGuide(){stopCamera();guideNode?.remove();guideNode=null;guideIndex=0;photoSummary=false;cameraMessage='';cameraFallback=false;cameraNeedsUpdate=false;}
  ...
  async function startCamera(){
    ...
    try{
      ...
      if(!navigator.mediaDevices?.getUserMedia){cameraFallback=true;cameraMessage='Live camera is unavailable here. Use Take photo or Upload below.';return;}
