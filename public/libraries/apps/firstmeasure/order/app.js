    ...
    <section class="r-step is-hidden" id="rStepReport" data-status="locked">
      ...
      <div class="r-report-order-group" id="rReportOptionGroup">
        ...
        <div id="rRoofReportFields">
          ...
          <div class="r-confirm" id="rConfirm"><div class="ic" id="rConfirmIc"><i class="far fa-square"></i></div><div class="tx" id="rConfirmTx">${(globalThis.PlatformLanguage?.text("firstmeasure","m_93a548f13a353b","I have placed a pin on every structure to be included in this report") ?? "I have placed a pin on every structure to be included in this report")}</div></div>
