...
<body>
  ...
  <script src="../../internal/portal_scripts/referral_partners.js?v=<?= htmlspecialchars($assetVersion, ENT_QUOTES, 'UTF-8') ?>"></script>
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      if (window.ReferralPartnersTab) window.ReferralPartnersTab.onShow();
    });
  </script>
</body>
</html>
