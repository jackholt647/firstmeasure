...
(function(){
  ...
  function resultsPayload(){const root=document.getElementById('mraResults');const get=id=>root?.querySelector(id)?.value||'';return{date_start:get('#mraRFStart'),date_end:get('#mraRFEnd'),team_id:get('#mraRFTeam'),qa_email:get('#mraRFQa'),audit_status:get('#mraRFStatus'),page:resultsPage,page_size:25}}
