...
(function(){
  ...
  function ensureStyles(){
    ...
    const css=`
      ...
      .mra-category-btn{min-width:0;min-height:22px;padding:2px 3px;font-family:inherit;font-size:10px;line-height:1.2;text-align:left;white-space:normal;overflow-wrap:anywhere}
      ...
      .mra-review-severity select{min-width:96px;max-width:55%;box-sizing:border-box;padding:5px 7px;border:1px solid #87929f;border-radius:6px;background:#343a40;color:#f8fafc;font-family:inherit;font-size:11px;line-height:1.2;color-scheme:dark}
      .mra-review-severity option{background:#343a40;color:#f8fafc}
