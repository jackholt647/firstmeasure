...
function perf_persist(touch=true) {
    ...
    function generate(soffit,resetBase=false) {
        ...
        try {
            ...
            const options={soffit,defaultSoffitInches:18,ground:state?.options.ground??estimateGround(),tolerance:state?.options.tolerance??18*G.INCH};
