...
export const localizationSchema = z.object({
  ...
  time_zone: z.string().max(100).refine(value => { try { new Intl.DateTimeFormat("en-US", { timeZone: value }); return true; } catch { return false; } }, "Unsupported time zone").optional()
}).strict();
