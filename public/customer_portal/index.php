...
<head>
  ...
  <script>
    ...
    window.__CUSTOMER_PORTAL = { id: <?php echo json_encode($portalId); ?>, preview: false };
  </script>
...
<body>
  <main id="customerPortalApp" class="cp-shell">
    <div class="cp-loading">Loading customer portal...</div>
  </main>
</body>
</html>
