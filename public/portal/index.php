  ...
  <style>
    ...
    *::-webkit-scrollbar-corner{background:transparent}
    ...
    @media (min-width:821px){
      ...
      .sidebar.sidebar-resize-enabled .sidebar-resize-edge{
        display:block;position:absolute;top:0;bottom:0;right:-4px;width:8px;
      ...
      .sidebar-resize-edge::before{
        ...
        transition:width .16s ease,right .16s ease,background-color .16s ease;
      }
      .sidebar-resize-edge:hover::before,.sidebar.sidebar-resizing .sidebar-resize-edge::before{
        right:1px;width:4px;background:var(--primary-readable,var(--primary,#d93025));
      }
