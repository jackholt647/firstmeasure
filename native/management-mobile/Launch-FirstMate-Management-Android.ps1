...
function Install-And-Launch {
    ...
    Step "Installing and launching FirstMate"
    & $adb install -r $apkPath | Out-Host
    & $adb shell am start -n ai.firstmate.management/.MainActivity | Out-Host
}
...
Write-Host "FirstMate Management Android launcher" -ForegroundColor Green
...
Write-Host ""
Write-Host "Ready. The emulator should show the FirstMate management portal." -ForegroundColor Green
Write-Host "Emulator URL: http://10.0.2.2:8021/apps/management-mobile/"
Write-Host "Local browser URL: http://127.0.0.1:8021/apps/management-mobile/"
