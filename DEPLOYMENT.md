...
September 23 AI aspect sizing: [Width-based opening shapes](deploy/digitalocean/development-exterior-ai-aspect-20260923.md) records `d1dc861aa99315b97e90a24af80d4795c86a91e1` on all three development roles. New placements derive physical height from percentage width and opening aspect ratio, preserving square shapes independently of hidden wall height. All 86 focused tests, PHP lint, public hashes and readiness passed. The three-file delta preserves `7a5daa9` and the private PHP API override; production is unchanged.

September 23 AI access and captures: [Private API bridge and continuous face borders](deploy/digitalocean/development-exterior-ai-access-20260923.md) records `7a5daa9c0f35ee5a85e393190610e3a218be0a38` on all three development roles. PHP project requests use the existing private development web API to avoid intermittent public route-not-found responses. Keep the compatibility PHP pool override during future releases. AI failures show above the table, and captures retain visible coplanar face boundaries. Browser regression, PHP lint, hashes, readiness and a live Sol response passed. This two-file delta preserves `ff8e94a`; production is unchanged.

September 23 soffit display: [Opaque occlusion and empty-click deselection](deploy/digitalocean/development-soffit-depth-20260923.md) records `ff8e94a3a66dc6dea5694705df968e91d4c3e36b` on all development roles. Opaque soffits use depth testing with the existing one-pixel bias; Resoffit misses clear unmodified selection. Ten editor checks, one selection regression and two Chrome WebGL tests passed. Public hashes/readiness are verified. The two-script delta preserves `1535481`; production is unchanged.

September 23 sticker wire correction: [Independent fill recalculation](deploy/digitalocean/development-sticker-wire-preservation-20260923.md) records `1535481284d21a6b1d6efd3a08071e6ee0bad249` on all development roles. Corrects `6fce7d7`: reconstructed sticker fill no longer consumes source wire, curve deletion tests the actual curve rather than its endpoint chord, and internal authored segments participate in fill reconstruction. All 461 focused checks passed; public hashes and role readiness are verified. The two-script delta preserves `8582050`; production is unchanged.

September 23 AI photo labels: [Elevation names in Stickers](deploy/digitalocean/development-exterior-ai-photo-labels-20260923.md) records `85820504dc5f700758257f17cb53f664511a83dc` on development. Photo choices show Front, Back, Left side, Right side or corner direction before filenames, honoring manual report assignments. Browser and label checks passed; public hash and activation readiness passed on all roles. This one-script delta preserves `6fce7d7`; production is unchanged.
...
September 23 curve nudges: [Held-arrow geometry batching and curve controls](deploy/digitalocean/development-nudge-geometry-20260923.md) records `a436c5eb94903434dedaff1fc9ab7d7cdb55c54c` on all development roles. Held wall/plane nudges accumulate distance with lightweight point previews, then publish one pending geometry transaction. Curve definitions and boundary controls follow endpoint movement; placed geometry restores selection. Unrelated faces skip slide normalization. All 509 focused tests passed, plus 64 final wall-mode checks; role readiness and all four public asset hashes passed. This delta preserves the complete `ebcfb8b` runtime. Production is unchanged.
...
September 23 AI stickers: [Configurable face opening counts](deploy/digitalocean/development-exterior-ai-stickers-20260923.md) records initial `95cce15`, prompt follow-up `55e5497` and final highlight release `b7b759cf7d848b9e5dc1dfccad2593ebc8026bf9` on development. Rotation/Stickers sub-tabs offer Luna, Sol and Astra, all-face or asynchronous per-face counts, manual photo/view inputs, clickable face rows and persistent browser history. A live Luna run returned all 34 visible faces; model accuracy remains experimental. Focused checks, PHP lint, public hashes and readiness passed. Row selection opens opaque mode; live selection was verified. The final delta preserves `ad5c325`, including concurrent nudge and photo zoom work. Production is unchanged.

September 23 nudge performance: [Latest-state rendering and snapshots](deploy/digitalocean/development-nudge-render-20260923.md) records `900b2158b332e5e4698fc72c46c7dd44b4386d55` on all development roles. Nudge bursts update 2D and selection feedback while full 3D rebuilds, backups and final history snapshots wait for 180 ms idle. Instrumented tests confirm 20 steps produce one settled rebuild/backup and preserve grouped undo. 470 focused checks passed, with 63 wall-mode checks repeated after the final optimization. Public hashes/readiness passed. This three-script delta preserves the complete `95cce15` runtime; production is unchanged.

September 23 repeated Move: [Preserve cancellation until placement](deploy/digitalocean/development-repeat-m-20260923.md) records verified release `794ef7c9f31483048bd63ec77cf2fa1d025caf1e`, retained in the current development runtime. Repeated M does not commit or restart single-direction moves; Escape restores the initial geometry and clicking creates one undo entry. All 407 focused checks passed. Production is unchanged.
...
September 23 point selection: [Multi-point nudging and Q ownership](deploy/digitalocean/development-selection-nudge-20260923.md) records `f0ec2e4ede04eb195c18c379d91ffde9a58a83b9` on all development roles. Partial point selections nudge together along their own connected edges in one undo operation; Q keeps draft-local IDs bound to the selected face. The two-file delta preserves the full `f9cc71f` runtime. 1,090 of 1,092 checks pass, with only the two previously documented curved-eave failures. Public asset hashes and readiness are verified. Production is unchanged.

September 23 experimental AI orbit: [Eight textured front candidates](deploy/digitalocean/development-exterior-ai-orbit-20260923.md) records `f9cc71f335a41cf9bbe4422009fe63e03f27578d` on all development roles. AI now captures eight fitted views 45 degrees apart, six feet above grade, and asks Luna low reasoning to select a numbered image. The live house run selected View 2 at 43% confidence, visually consistent with the front elevation but not an exact pose. All 85 selected checks, public hashes and readiness passed. The four-file delta preserves the complete `0642b848` runtime; production is unchanged.

September 23 line arching: [Spline editing of existing lines](deploy/digitalocean/development-line-arch-20260923.md) records `0642b848b03dcfde922c86360839a39ead92b0d4` on all development roles. A curves a selected line through multiple clicked points with symmetric and midpoint snapping; Enter, double-click or A finishes, Escape cancels. Actual face boundaries and draft graphs retain the spline for extrusion. New arch checks pass; the expanded suite has two verified pre-existing curved-eave failures. Public asset hashes/readiness passed; browser loading timeouts prevented the live interaction check. The five-file delta preserves the full `a9392d0` runtime; production is unchanged.

September 23 experimental AI camera: [Luna front-view matching](deploy/digitalocean/development-exterior-ai-camera-20260923.md) records `a9392d0d46c367e9e88d5960a6481cadd1f7e9d3` on development. The narrow AI tab uses GPT-6 Luna low reasoning for initial camera position and up to three refinements, with local screenshot history/export. Owner-only development access and a private server key keep the experiment isolated. Live pipeline and automated checks passed; the first real-house match remained low confidence. Production is unchanged.

September 23 DSM chimney tops: [Flat caps at the footprint maximum](deploy/digitalocean/development-chimney-dsm-top-20260923.md) records `5fc5918fc042ebabd1ea67defab50a2861025de7` on all development roles. From Roof uses the highest valid DSM pixel within each chimney footprint for its flat top, retaining the one-foot fallback when no usable height rises above the roof. All 1,058 relevant tests passed, with captured-house From Roof assertions and public asset/readiness verification. This one-file editor delta preserves the complete `4588f07` runtime. Production is unchanged.

September 23 DSM ground sampling: [Pick flat grade from the DSM](deploy/digitalocean/development-dsm-ground-sampling-20260923.md) records `4588f07769e7a995b1042c93bbafd19e66e65538` on all development roles. Grade > DSM shows the DSM and lets a clicked ground point set flat grade and update the base and attached walls in one undo step. Supported automatic ground planes remain the initial default. All 1,049 relevant checks passed; final handler checks, public asset hashes, readiness and live picking/cancellation smoke checks passed. This four-file editor delta preserves the complete `5f1ea33` publication runtime. Production is unchanged.

September 23 publication architecture: [Data, code, actions and native builders](deploy/digitalocean/development-publication-architecture-20260923.md) records `5f1ea338f6ce3707c7374884f79de20f5529bff1` on all development roles. This deploys inherited architecture `4a3c46c` plus its completed builder, dependency, authorization and measurement integration. Linux build, publication tests and authenticated cross-app development smoke checks passed. All 226 internal editor files remain identical to the prior `974f20e` runtime. Production is unchanged; preserve this combined runtime baseline.

September 23 canonical wall geometry: [Shared source, mesh and boundary](deploy/digitalocean/development-canonical-wall-geometry-20260923.md) records `974f20e6639bbe4a4a1011bd69d67cd20edf0ef6` on all development roles. Generated wall coordinates and filled regions now match their editable boundaries; overlapping strips use planar union, extrusion follows canonical contacts, and divider movement follows changing wall profiles. 1,038 relevant checks passed; public assets and readiness are verified. This is a five-file editor delta from `ccc45af`; architecture `4a3c46c` and concurrent platform work remain undeployed. Preserve this runtime baseline.
