...
September 23 AI stickers: [Configurable face opening counts](deploy/digitalocean/development-exterior-ai-stickers-20260923.md) records initial `95cce15` and final `55e5497f9305219e6fd7e1c35b82f2e5f7457f90` on development. Rotation/Stickers sub-tabs offer Luna, Sol and Astra, all-face or asynchronous per-face counts, manual photo/view inputs, clickable face rows and persistent browser history. A live Luna run returned all 34 visible faces; model accuracy remains experimental. Focused checks, PHP lint, public hashes and readiness passed. The final delta preserves `900b215`, including concurrent nudge work. Production is unchanged.
